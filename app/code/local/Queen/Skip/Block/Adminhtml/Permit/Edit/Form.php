	...
	protected function _prepareForm()
{
	...
	$fieldset->addField('authority', 'text', array(
		'name'      => 'authority',
		'label'     => Mage::helper('adminhtml')->__('Authority'),
		'title'     => Mage::helper('adminhtml')->__('Authority'),
		'required'  => true,
	));
	...
	$fieldset->addField('duration', 'text', array(
		'name'      => 'duration',
		'label'     => Mage::helper('adminhtml')->__('Duration'),
		'title'     => Mage::helper('adminhtml')->__('Duration'),
		'required'  => true,
	));
	...
	$fieldset->addField('price', 'text', array(
		...
		'title'     => Mage::helper('adminhtml')->__('Price'),
		'required'  => true,
	));
